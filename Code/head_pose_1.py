...
object_pts = np.float32(
    ...
    ], [-6.825897, 6.760612, 4.402142], [5.311432, 5.485328, 3.987654], [
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                cv2.putText(frame,"X: " + "{:7.2f}".format(euler_angle[0, 0]), (20, 100),
                    cv2.FONT_HERSHEY_SIMPLEX,0.75, (0, 0, 0),thickness=2)
                cv2.putText(frame,"Y: " + "{:7.2f}".format(euler_angle[1, 0]), (20, 130),
                    cv2.FONT_HERSHEY_SIMPLEX,0.75, (0, 0, 0),thickness=2)
                cv2.putText(frame,"Z: " + "{:7.2f}".format(euler_angle[2, 0]), (20, 160),
                    cv2.FONT_HERSHEY_SIMPLEX,0.75, (0, 0, 0),thickness=2)
